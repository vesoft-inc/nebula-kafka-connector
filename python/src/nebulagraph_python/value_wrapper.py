...
from nebulagraph_python.data_types import ColumnType
...
class ValueWrapper:
    ...
    def cast(
        ...
        if self.value is None and target_type is None:
            return None
        column_target_type = ColumnToPy[self.data_type]
        target_type = column_target_type if target_type is None else target_type  # type: ignore
    ...
    def cast_primitive(self) -> TargetPrimitiveType:
