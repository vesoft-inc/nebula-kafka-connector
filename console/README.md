...
1. Build Nebula Graph Console
    ...
    ```bash
    $ git clone https://github.com/vesoft-inc/nebula-ng-tools/console
    ```
...
- Download the binaries on the [Releases page](https://github.com/vesoft-inc/nebula-ng-tools/console/releases)
