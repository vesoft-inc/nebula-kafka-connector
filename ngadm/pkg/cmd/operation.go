...
func RegisteOperationCmd(rootCmd *cobra.Command) {
	startCmd := &cobra.Command{
		...
		Long:  `start nebula cluster by config file which is default to .ngadm.yaml ` + ProductInfo,
	...
	stopCmd := &cobra.Command{
		...
		Long:  `stop nebula cluster by config file which is default to .ngadm.yaml ` + ProductInfo,
		Run: func(cmd *cobra.Command, args []string) {
	...
	restartCmd := &cobra.Command{
		...
		Long:  `restart nebula cluster by config file which is default to .ngadm.yaml ` + ProductInfo,
		Run: func(cmd *cobra.Command, args []string) {
