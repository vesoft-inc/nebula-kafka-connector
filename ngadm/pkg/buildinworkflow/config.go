			...
			SubTasks: []*types.TaskSpec{
				{
					...
					Params: &tasks.ConfigParams{
						...
						Type:   "nebulagraph",
						Dst:    path.Join(utils.GetCluster(spec.InstallPath), "etc/nebula-metad.conf"),
					},
				},
			},
		})
				...
				SubTasks: []*types.TaskSpec{
					{
						...
						Params: &tasks.ConfigParams{
							...
							Type:   "nebulagraph",
							Dst:    path.Join(utils.GetCluster(spec.InstallPath), "etc/nebula-graphd.conf"),
						},
					},
				},
			})
				...
				SubTasks: []*types.TaskSpec{
					{
						...
						Params: &tasks.ConfigParams{
							...
							Dst:    path.Join(utils.GetCluster(spec.InstallPath), "etc/nebula-storaged.conf"),
							Type:   "nebulagraph",
						},
					},
				},
