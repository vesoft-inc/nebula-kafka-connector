...
func UninstallServiceGroup(args map[string]any, spec *types.JobSpec) (*types.WorkflowSpec, error) {
	workflow := &types.WorkflowSpec{
		Type:     "serial",
		Rollback: spec.Rollback,
		Tasks:    []*types.TaskSpec{},
	}
	uninstallTask, err := BuildUninstallServiceGroupTask(args, spec)
	if err != nil {
		return nil, err
	}
...
func BuildUninstallServiceGroupTask(args map[string]any, spec *types.JobSpec) (*types.TaskSpec, error) {
