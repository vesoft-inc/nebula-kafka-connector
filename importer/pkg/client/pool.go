//go:generate mockgen -source=pool.go -destination pool_mock.go -package client -aux_files github.com/vesoft-inc/nebula-ng-tools/importer/pkg/client=client.go Pool
package client
