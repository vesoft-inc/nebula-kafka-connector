...
func (e *nebulaExporter) Reconcile(metaClient meta.Client, cluster *v1alpha1.NebulaCluster) error {
	if cluster.Spec.Exporter == nil {
		return nil
	}

	if err := e.syncExporterService(cluster); err != nil {
		return err
	}

	return e.syncExporterDeployment(cluster)
}
