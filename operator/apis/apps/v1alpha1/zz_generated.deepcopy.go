...
func (in *GraphProjection) DeepCopyInto(out *GraphProjection) {
	*out = *in
	if in.GraphSource != nil {
		in, out := &in.GraphSource, &out.GraphSource
		*out = new(GraphSource)
		(*in).DeepCopyInto(*out)
	}
	if in.CreationWaitingSeconds != nil {
		in, out := &in.CreationWaitingSeconds, &out.CreationWaitingSeconds
		*out = new(int64)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GraphSource) DeepCopyInto(out *GraphSource) {
	*out = *in
	if in.GraphReference != nil {
		in, out := &in.GraphReference, &out.GraphReference
		*out = new(string)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GraphSource.
func (in *GraphSource) DeepCopy() *GraphSource {
	if in == nil {
		return nil
	}
	out := new(GraphSource)
...
func (in *GraphdSpec) DeepCopyInto(out *GraphdSpec) {
	*out = *in
	in.ComponentSpec.DeepCopyInto(&out.ComponentSpec)
	if in.GraphProjection != nil {
		in, out := &in.GraphProjection, &out.GraphProjection
		*out = new(GraphProjection)
		(*in).DeepCopyInto(*out)
	}
	if in.Config != nil {
