...
func (in *NebulaClusterSpec) DeepCopyInto(out *NebulaClusterSpec) {
	*out = *in
	...
	if in.MetadHost != nil {
		in, out := &in.MetadHost, &out.MetadHost
		*out = new(NebulaHost)
		**out = **in
	}
	if in.Zones != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NebulaHost) DeepCopyInto(out *NebulaHost) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NebulaHost.
func (in *NebulaHost) DeepCopy() *NebulaHost {
	if in == nil {
		return nil
	}
	out := new(NebulaHost)
