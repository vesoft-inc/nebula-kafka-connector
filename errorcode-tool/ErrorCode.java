...
public enum ErrorCode {
    ...
    INVALID_SYNTAX_NEST_QUERY_RETURN_ITEM_ERROR("42N40"),
    ...
    INVALID_SYNTAX_ACCUM_MATCH_CLAUSE_ERROR("42N51"),
    INVALID_SYNTAX_ASSIGN_GLOBAL_ACCUM_ERROR("42N52"),
    INVALID_SYNTAX_ASSIGN_NODE_ACCUM_ERROR("42N53"),
    INVALID_SYNTAX_INVALID_NODE_VAR_REFERENCE("42N54"),
    INVALID_SYNTAX_SET_PROPERTY("42N55"),
    INVALID_SYNTAX_ACCUMULATOR_NOT_DEFINED("42N56"),
    ...
    KVSTORE_ERROR("NK000"),
    KVSTORE_BATCH_WRITE_FAILED("NK001"),
    KVSTORE_GET_PROPERTY_FAILED("NK002"),
    KVSTORE_SET_OPTION_FAILED("NK003"),
    KVSTORE_KEY_NOT_FOUND("NK004"),
    KVSTORE_COMMIT_FAILED("NK005"),
    KVSTORE_GET_FAILED("NK006"),
    KVSTORE_PUT_FAILED("NK007"),
    KVSTORE_REMOVE_FAILED("NK008"),
    KVSTORE_INGEST_FAILED("NK009"),
    KVSTORE_COMPACT_FAILED("NK010"),
    KVSTORE_FLUSH_FAILED("NK011"),
    KVSTORE_CHECKPOINT_FAILED("NK012"),
    KVSTORE_COLUMN_FAMILY_NOT_FOUND("NK013"),
    KVSTORE_OPEN_FAILED("NK014"),
    KVSTORE_OPTIONS_INVALID("NK015"),
    KVSTORE_LOCK_FAILED("NK016"),
    KVSTORE_EXPORT_TABLE_FAILED("NK017"),
    KVSTORE_OPEN_SST_FAILED("NK018"),
    KVSTORE_PREFIX_INVALID("NK019"),
    CATALOG_ERROR("NC000"),
    ...
    RPC_FAILED("NN001"),
    RPC_REQUEST_INVALID("NN002"),
    RPC_REQUEST_HANDLER_NOT_FOUND("NN003"),
    RPC_RETRY_FAILED("NN004"),
    RPC_DESERIALIZE_ERROR("NN005"),
    RPC_DESERIALIZE_OBJECT_TYPE_ERROR("NN006"),
    RPC_STORAGE_SERVICE_NOT_FOUND("NN007"),
    ...
    ANALYTIC_ACCUMULATOR_NOT_FOUND("AN301"),
    ANALYTIC_ACCUMULATOR_EXIST("AN302"),
    ANALYTIC_INVALID_ACCUMULATOR_TYPE("AN303"),
    ...
    META_NOT_SUPPORTED("NM001"),
    META_NOT_INIT("NM002"),
    META_RESP_NOT_SET("NM003"),
    META_WRITE_KV_FAILED("NM004"),
    META_SERVICE_NOT_FOUND("NM005"),
    META_SERVICE_ID_ERROR("NM006"),
    META_GET_KV_PREFIX_FAILED("NM007"),
    META_PUT_SERVICE_ADDRESS_FAILED("NM008"),
    META_LIST_SERVICE_FAILED("NM009"),
    META_CANNOT_FIND_SERVICE("NM010"),
    GET_META_CLIENT_FAILED("NM011"),
    META_UNSUPPORTED_SERVICE("NM012"),
    META_SERVICE_FAIL_TO_ALLOC_ID("NM013"),
    ...
    RAFT_INVALID_PEER("NA001"),
    RAFT_RPC_EXCEPTION("NA002"),
    RAFT_TIMEOUT("NA003"),
    RAFT_CATCHUP("NA004"),
    RAFT_LEADER_REMOVED("NA005"),
    RAFT_SET_PEER("NA006"),
    RAFT_NODE_STOP("NA007"),
    RAFT_HIGHER_TERM_REQUEST("NA008"),
    RAFT_HIGHER_TERM_RESPONSE("NA009"),
    RAFT_BAD_NODE("NA010"),
    RAFT_VOTE_FOR_CANDIDATE("NA011"),
    RAFT_NEW_LEADER("NA012"),
    RAFT_LEADER_CONFLICT("NA013"),
    RAFT_TRANSFER_LEADER("NA014"),
    RAFT_STOP("NA015"),
    RAFT_BUSY("NA016"),
    RAFT_INVALID("NA017"),
    RAFT_FAILED("NA018"),
    RAFT_SNAPSHOT_FAILED("NA019"),
    ...
    GRAPH_PROJECTION_BASE_NOT_FOUND("NR121"),
    MEMORY_GRAPH_ALREADY_EXIST("NR122"),
    MEMORY_GRAPH_NOT_FOUND("NR123"),
    MEMORY_GRAPH_BUILD_FAILED("NR124"),
    MEMORY_GRAPH_INVALID_DATA_SOURC_FUNC("NR125"),
    ...
    ANALYTIC_QUERY_RUNNING_ON_GRAPH("NR501"),
    INTERPRETER_ERROR("NR502"),
    VECTOR_DIMENSION_MISSMATCHED("NW501"),
    UNSUPPORTED_VECTOR_METRIC_TYPE("NW502"),
    UNSUPPORTED_VECTOR_DISTANCE_TYPE("NW503"),
    ANN_INDEX_CREATE_FAILED("NW504"),
    ANN_INDEX_BUILD_FAILED("NW505"),
    ANN_INDEX_ALREADY_EXIST("NW506"),
    ANN_INDEX_NOT_FOUND("NW507"),
    ANN_INDEX_ADD_FAILED("NW508"),
    ANN_INDEX_SEARCH_FAILED("NW509"),
    ANN_INDEX_WRITE_FAILED("NW510"),
    ANN_INDEX_READ_FAILED("NW511"),
    ANN_INDEX_REMOVE_FAILED("NW512"),
    ANN_INDEX_MANAGER_ADD_FAILED("NW513"),
    ANN_INDEX_MANAGER_REMOVE_FAILED("NW514"),
    ANN_INDEX_RECONSTRUCT_FAILED("NW515"),
    ANN_WAL_WRITE_FAILED("NW516"),
    ANN_WAL_READ_FAILED("NW517"),
    ANN_WAL_FLUSH_FAILED("NW518"),
    ANN_WAL_FSYNC_FAILED("NW519"),
    ...
    DUPLICATE_DEFINE_ACCUMULATOR("NS231"),
    INVALID_ACCUMULATOR_OPERATION("NS232"),
    INVALID_ACCUMULATOR_DEFINITION("NS233"),
    ...
    UNSUPPORTED_ACCUM_MATCH_PATH_PATTERN("NT302"),
    ...
    STATS_ERROR("NY002"),
    FILE_ERROR("NY101"),
    FILE_NOT_FOUND("NY102"),
    FILE_IS_EMPTY("NY103"),
    FILE_READ_PERMISSION("NY104"),
    FILE_READ_LINK("NY105"),
    FILE_READ_PATH("NY106"),
    FILE_OPEN_DIR("NY107"),
    FILE_OPEN_FAILED("NY108"),
    FILE_TYPE_NOT_SUPPORT("NY109"),
    FILE_FILE_STATE("NY110"),
    FILE_CREATE_DIR_FAILED("NY111"),
    FILE_READ_SERVICE_ID_FILE_ERROR("NY112"),
    FILE_PARSE_SERVICE_ID_FILE_ERROR("NY113"),
    FILE_SAVE_SERVICE_ID_FILE_ERROR("NY114"),
    FILE_REMOVE_DIR_FAILED("NY115"),
    FILE_REMOVE_FAILED("NY116"),
    FILE_CLOSE_FAILED("NY117"),
    MEMORY_ERROR("NY201"),
    MEMORY_CONFIG_ERROR("NY202"),
    MEMORY_BACKGROUND_CHECK("NY203"),
    MEMORY_SYSTEM_INFO("NY204"),
    MEMORY_VECTOR_INVALID_SIZE("NY205"),
    NETWORK_ERROR("NY301"),
    NETWORK_CREATE_SOCKET("NY302"),
    NETWORK_UNKNOWN_ADDR("NY303"),
    NETWORK_BIND_FAILED("NY304"),
    NETWORK_LISTEN_FAILED("NY305"),
    NETWORK_NBIO_STOPPED("NY306"),
    NETWORK_CONN_CLOSED("NY307"),
    NETWORK_PROTOCOL("NY308"),
    NETWORK_TIMEOUT("NY309"),
    NETWORK_DISCONNECTED("NY310"),
    NETWORK_ADDR_NOT_FOUND("NY311"),
    NETWORK_INVALID_HOST("NY312"),
    NETWORK_TLS_ERROR("NY313"),
    READ_METRIC_FAILED("NY401"),
    THREAD_ERROR("NY501"),
    THREAD_CREATE_FAILED("NY502"),
    SYS_GRAPH_ERROR("NY601"),
