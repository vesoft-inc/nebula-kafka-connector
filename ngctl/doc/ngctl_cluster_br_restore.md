## ngctl cluster br restore

Restore data files, notice that it will restart the cluster

### Options

```
      --agents string          Specify agents address, eg: 192.168.8.1:6688,192.168.8.2:6688,192.168.8.3:6688
      --backup-clusterId int   Specify the backup cluster id
      --ca-path string         Specify CA file path (default "/usr/local/certs/ca.crt")
      --catalog-owner string   Specify the restore cluster catalog owner (default "root")
      --cert-path string       Specify cert file path (default "/usr/local/certs/client.crt")
      --clusterId int          Specify the restore cluster id
...
* [ngctl cluster br restore full](ngctl_cluster_br_restore_full.md)	 - full restore all clusters data files
