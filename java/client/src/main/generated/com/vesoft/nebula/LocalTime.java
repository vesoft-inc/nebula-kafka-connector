...
public class LocalTime implements TBase, java.io.Serializable, Cloneable, Comparable<LocalTime> {
  private static final TStruct STRUCT_DESC = new TStruct("_LocalTime_");
  ...
  static {
    FieldMetaData.addStructMetaDataMap(LocalTime.class, metaDataMap);
  }
  ...
  public LocalTime setHour(byte hour) {
    this.hour = hour;
    setHourIsSet(true);
    return this;
  }
  ...
  public LocalTime setMinute(byte minute) {
    this.minute = minute;
    setMinuteIsSet(true);
    return this;
  }
  ...
  public LocalTime setSec(byte sec) {
    this.sec = sec;
    setSecIsSet(true);
    return this;
  }
  ...
  public LocalTime setMicrosec(int microsec) {
    this.microsec = microsec;
    setMicrosecIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object _that) {
    ...
    if (this == _that)
      return true;
    if (!(_that instanceof LocalTime))
      return false;
    LocalTime that = (LocalTime)_that;
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("_LocalTime_");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
