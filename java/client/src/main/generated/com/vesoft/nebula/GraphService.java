...
public class GraphService {
  ...
  public static class AsyncClient extends TAsyncClient implements AsyncIface {
    ...
    public void authenticate(AuthReq authReq, AsyncMethodCallback resultHandler41) throws TException {
      checkReady();
      authenticate_call method_call = new authenticate_call(authReq, resultHandler41, this, ___protocolFactory, ___transport);
    ...
    public static class authenticate_call extends TAsyncMethodCall {
      ...
      public authenticate_call(AuthReq authReq, AsyncMethodCallback resultHandler42, TAsyncClient client38, TProtocolFactory protocolFactory39, TNonblockingTransport transport40) throws TException {
    ...
    public void signout(long sessionId, AsyncMethodCallback resultHandler46) throws TException {
      checkReady();
      signout_call method_call = new signout_call(sessionId, resultHandler46, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class signout_call extends TAsyncMethodCall {
      ...
      public signout_call(long sessionId, AsyncMethodCallback resultHandler47, TAsyncClient client43, TProtocolFactory protocolFactory44, TNonblockingTransport transport45) throws TException {
    ...
    public void execute(long sessionId, byte[] stmt, AsyncMethodCallback resultHandler51) throws TException {
      checkReady();
      execute_call method_call = new execute_call(sessionId, stmt, resultHandler51, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class execute_call extends TAsyncMethodCall {
      private long sessionId;
      private byte[] stmt;
      public execute_call(long sessionId, byte[] stmt, AsyncMethodCallback resultHandler52, TAsyncClient client48, TProtocolFactory protocolFactory49, TNonblockingTransport transport50) throws TException {
