...
public class GraphService {
  ...
  public interface Iface {
    ...
    public AuthResponse authenticate(AuthReq authReq) throws TException;
  ...
  public interface AsyncIface {
    ...
    public void authenticate(AuthReq authReq, AsyncMethodCallback resultHandler) throws TException;
  ...
  public static class Client extends EventHandlerBase implements Iface, TClientIf {
    ...
    public AuthResponse authenticate(AuthReq authReq) throws TException
    {
      ...
      send_authenticate(authReq);
      return recv_authenticate();
    }

    public void send_authenticate(AuthReq authReq) throws TException
    {
  ...
  public static class AsyncClient extends TAsyncClient implements AsyncIface {
    ...
    public void authenticate(AuthReq authReq, AsyncMethodCallback resultHandler32) throws TException {
      checkReady();
      authenticate_call method_call = new authenticate_call(authReq, resultHandler32, this, ___protocolFactory, ___transport);
    ...
    public static class authenticate_call extends TAsyncMethodCall {
      ...
      public authenticate_call(AuthReq authReq, AsyncMethodCallback resultHandler33, TAsyncClient client29, TProtocolFactory protocolFactory30, TNonblockingTransport transport31) throws TException {
    ...
    public void signout(long sessionId, AsyncMethodCallback resultHandler37) throws TException {
      checkReady();
      signout_call method_call = new signout_call(sessionId, resultHandler37, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class signout_call extends TAsyncMethodCall {
      ...
      public signout_call(long sessionId, AsyncMethodCallback resultHandler38, TAsyncClient client34, TProtocolFactory protocolFactory35, TNonblockingTransport transport36) throws TException {
        super(client34, protocolFactory35, transport36, resultHandler38, true);
    ...
    public void execute(long sessionId, byte[] stmt, AsyncMethodCallback resultHandler42) throws TException {
      checkReady();
      execute_call method_call = new execute_call(sessionId, stmt, resultHandler42, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class execute_call extends TAsyncMethodCall {
      private long sessionId;
      private byte[] stmt;
      public execute_call(long sessionId, byte[] stmt, AsyncMethodCallback resultHandler43, TAsyncClient client39, TProtocolFactory protocolFactory40, TNonblockingTransport transport41) throws TException {
  ...
  public static class Processor implements TProcessor {
    ...
    private class authenticate implements ProcessFunction {
      public void process(int seqid, TProtocol iprot, TProtocol oprot, TConnectionContext server_ctx) throws TException
      {
        ...
        authenticate_result result = new authenticate_result();
        result.success = iface_.authenticate(args.authReq);
  ...
  public static class authenticate_args implements TBase, java.io.Serializable, Cloneable, Comparable<authenticate_args>   {
    ...
    private static final TField AUTH_REQ_FIELD_DESC = new TField("authReq", TType.STRUCT, (short)1);

    public AuthReq authReq;
    public static final int AUTHREQ = 1;
    ...
    static {
      ...
      tmpMetaDataMap.put(AUTHREQ, new FieldMetaData("authReq", TFieldRequirementType.DEFAULT, 
          new StructMetaData(TType.STRUCT, AuthReq.class)));
    ...
    public authenticate_args(authenticate_args other) {
      if (other.isSetAuthReq()) {
        this.authReq = TBaseHelper.deepCopy(other.authReq);
      }
    }
    ...
    public authenticate_args setAuthReq(AuthReq authReq) {
      this.authReq = authReq;
      return this;
    }
    ...
    public void setAuthReqIsSet(boolean __value) {
      if (!__value) {
        this.authReq = null;
      }
    }
    ...
    public boolean equals(Object _that) {
      ...
      if (!TBaseHelper.equalsNobinary(this.isSetAuthReq(), that.isSetAuthReq(), this.authReq, that.authReq)) { return false; }
    ...
    @Override
    public int hashCode() {
      return Arrays.deepHashCode(new Object[] {authReq});
    }
    ...
    public int compareTo(authenticate_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetAuthReq()).compareTo(other.isSetAuthReq());
      if (lastComparison != 0) {
        return lastComparison;
      }
      lastComparison = TBaseHelper.compareTo(authReq, other.authReq);
      if (lastComparison != 0) { 
        return lastComparison;
      }
      return 0;
    ...
    public String toString(int indent, boolean prettyPrint) {
      ...
      if (this.getAuthReq() == null) {
        sb.append("null");
      } else {
        sb.append(TBaseHelper.toString(this.getAuthReq(), indent + 1, prettyPrint));
      }
      first = false;
