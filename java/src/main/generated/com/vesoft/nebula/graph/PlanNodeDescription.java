...
public class PlanNodeDescription implements TBase, java.io.Serializable, Cloneable, Comparable<PlanNodeDescription> {
  ...
  private static final TField DEPENDENCIES_FIELD_DESC = new TField("dependencies", TType.LIST, (short)6);
  ...
  public static final int DEPENDENCIES = 6;
  ...
  @Override
  public int hashCode() {
    return Arrays.deepHashCode(new Object[] {name, id, output_var, description, profiles, dependencies});
  }
