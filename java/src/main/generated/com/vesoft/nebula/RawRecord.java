...
public class RawRecord implements TBase, java.io.Serializable, Cloneable {
  private static final TStruct STRUCT_DESC = new TStruct("RawRecord");
  ...
  public RawRecord setValues(List<Value> values) {
    this.values = values;
    return this;
  }
          ...
          if (__field.type == TType.LIST) {
            {
              ...
              this.values = new ArrayList<Value>(Math.max(0, _list23.size));
              for (int _i24 = 0; 
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("RawRecord");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
