...
/**
  ...
  * TODO support ssl
  */
case class OSSSourceConfigEntry(override val category: SourceCategory.Value,
  ...
  override def check(): Unit = {
    ...
    require(endpoint != null && endpoint.nonEmpty, "endpoint for oss cannot be null")
    require(accessKey != null && accessKey.nonEmpty, "accessKey for oss cannot be null")
    require(secretKey != null && secretKey.nonEmpty, "secretKey for oss cannot be null")
  }
