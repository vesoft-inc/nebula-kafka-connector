...
package com.vesoft.nebula.spark.common.mock
...
class NebulaGraphMock {
  ...
  val address = "127.0.0.1:9669"
  val user    = "root"
  val passwd  = "nebula"
  @transient val nebulaClient =
    NebulaClient.builder(address, user, passwd).setMaxSessionSize(1).build()
