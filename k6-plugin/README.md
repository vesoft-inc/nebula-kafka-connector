...
```bash
xk6 build --with github.com/vesoft-inc/nebula-ng-tools/k6-plugin@{version}
# e.g. build v0.0.8
xk6 build --with github.com/vesoft-inc/nebula-ng-tools/k6-plugin@v0.0.8
# e.g. build master
xk6 build --with github.com/vesoft-inc/nebula-ng-tools/k6-plugin@master
```
