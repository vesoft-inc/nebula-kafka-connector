...
func LocalUploadHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.LocalUploadReq
		...
		l := storage.NewLocalUploadLogic(r.Context(), svcCtx)
		data, err := l.LocalUpload(&req)
