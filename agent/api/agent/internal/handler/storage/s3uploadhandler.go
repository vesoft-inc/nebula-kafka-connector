...
func S3UploadHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.S3UploadReq
		...
		l := storage.NewS3UploadLogic(r.Context(), svcCtx)
		data, err := l.S3Upload(&req)
