...
func S3DownloadHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.S3DownloadReq
		...
		l := storage.NewS3DownloadLogic(r.Context(), svcCtx)
		data, err := l.S3Download(&req)
