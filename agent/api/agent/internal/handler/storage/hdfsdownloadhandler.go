...
func HdfsDownloadHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.HDFSDownloadReq
		...
		l := storage.NewHdfsDownloadLogic(r.Context(), svcCtx)
		data, err := l.HdfsDownload(&req)
