...
func GetCmdExecuteAsyncStatusHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetCmdExecuteAsyncStatusReq
		...
		l := common.NewGetCmdExecuteAsyncStatusLogic(r.Context(), svcCtx)
		data, err := l.GetCmdExecuteAsyncStatus(&req)
