...
func CmdExecuteHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CmdExecuteReq
		...
		l := common.NewCmdExecuteLogic(r.Context(), svcCtx)
		data, err := l.CmdExecute(&req)
