...
typedef i32 (cpp.type = "nebula::SpaceID") SpaceID
typedef i32 (cpp.type = "nebula::PartID") PartID
...
struct AskForVoteRequest {
    1: SpaceID space;              // The graph space id
    2: PartID  part;               // The data partition
...
struct AppendLogRequest {
    1: SpaceID        space;               // Graphspace ID
    2: PartID         part;                // Partition ID
