...
const std::array<::nebula::cpp2::ValueType, 13>
        TEnumDataStorage<::nebula::cpp2::ValueType>::values = {{
                type::kNull,
                type::kBool,
                type::kInt8,
                type::kInt16,
...
const std::array<::nebula::cpp2::ErrorCode, 170>
        TEnumDataStorage<::nebula::cpp2::ErrorCode>::values = {{
                type::SUCCEEDED,
                type::E_DISCONNECTED,
...
const std::array<::nebula::cpp2::Value::Type, 12>
        TEnumDataStorage<::nebula::cpp2::Value::Type>::values = {{
                type::boolVal,
                type::int8Val,
                type::int16Val,
                type::int32Val,
...
const std::array<folly::StringPiece, 1>
        TStructDataStorage<::nebula::cpp2::NList>::fields_names = {{
                "values",
        }};
...
const std::array<folly::StringPiece, 12>
        TStructDataStorage<::nebula::cpp2::Value>::fields_names = {{
                "boolVal",
                "int8Val",
                "int16Val",
                "int32Val",
...
const std::array<folly::StringPiece, 2>
        TStructDataStorage<::nebula::cpp2::FieldType>::fields_names = {{
                "filedName",
                "valueType",
        }};
...
const std::array<protocol::TType, 2>
        TStructDataStorage<::nebula::cpp2::FieldType>::fields_types = {{
                TType::T_STRING,
                TType::T_I32,
        }};

const std::array<folly::StringPiece, 2>
        TStructDataStorage<::nebula::cpp2::RecordType>::fields_names = {{
                "fieldType",
                "fieldNameIndexMap",
        }};
...
const std::array<protocol::TType, 2>
        TStructDataStorage<::nebula::cpp2::RecordType>::fields_types = {{
                TType::T_LIST,
                TType::T_MAP,
        }};

const std::array<folly::StringPiece, 1>
        TStructDataStorage<::nebula::cpp2::RawRecord>::fields_names = {{
                "values",
        }};
...
const std::array<protocol::TType, 1>
        TStructDataStorage<::nebula::cpp2::RawRecord>::fields_types = {{
                TType::T_LIST,
        }};

const std::array<folly::StringPiece, 1>
        TStructDataStorage<::nebula::cpp2::BindingTable>::fields_names = {{
                "records",
        }};
const std::array<int16_t, 1> TStructDataStorage<::nebula::cpp2::BindingTable>::fields_ids = {{
        1,
}};
const std::array<protocol::TType, 1>
        TStructDataStorage<::nebula::cpp2::BindingTable>::fields_types = {{
                TType::T_LIST,
        }};
