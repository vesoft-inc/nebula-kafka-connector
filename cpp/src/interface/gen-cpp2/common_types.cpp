...
folly::Range<::nebula::cpp2::ValueType const*> const TEnumTraits<::nebula::cpp2::ValueType>::values = folly::range(TEnumDataStorage<::nebula::cpp2::ValueType>::values);
folly::Range<folly::StringPiece const*> const TEnumTraits<::nebula::cpp2::ValueType>::names = folly::range(TEnumDataStorage<::nebula::cpp2::ValueType>::names);
...
const _ValueType_EnumMapFactory::ValuesToNamesMapType _ValueType_VALUES_TO_NAMES = _ValueType_EnumMapFactory::makeValuesToNamesMap();
const _ValueType_EnumMapFactory::NamesToValuesMapType _ValueType_NAMES_TO_VALUES = _ValueType_EnumMapFactory::makeNamesToValuesMap();
FOLLY_POP_WARNING
...
NList::NList(apache::thrift::FragileConstructor, std::pmr::vector<nebula::client::Value> values__arg) :
...
Node::Node(apache::thrift::FragileConstructor, ::nebula::cpp2::InternalID nodeID__arg, ::nebula::cpp2::NodeTypeID nodeTypeID__arg, std::pmr::unordered_map<::std::string, nebula::client::Value> properties__arg) :
...
const std::pmr::unordered_map<::std::string, nebula::client::Value>& Node::get_properties() const& {
...
Edge::Edge(apache::thrift::FragileConstructor, ::nebula::cpp2::InternalID srcID__arg, ::nebula::cpp2::InternalID dstID__arg, ::nebula::cpp2::EdgeTypeID edgeTypeID__arg, ::nebula::cpp2::EdgeRank rank__arg, std::pmr::unordered_map<::std::string, nebula::client::Value> properties__arg) :
...
const std::pmr::unordered_map<::std::string, nebula::client::Value>& Edge::get_properties() const& {
  return __fbthrift_field_properties;
}
...
FieldType::FieldType(apache::thrift::FragileConstructor, ::std::string filedName__arg, nebula::client::ValueType valueType__arg) :
...
void FieldType::__clear() {
  // clear all fields
  this->__fbthrift_field_filedName = apache::thrift::StringTraits<std::string>::fromStringLiteral("");
...
bool FieldType::operator==(const FieldType& rhs) const {
  ...
  auto& lhs = *this;
  (void)lhs;
  if (!apache::thrift::StringTraits<std::string>::isEqual(lhs.__fbthrift_field_filedName, rhs.__fbthrift_field_filedName)) {
    return false;
  }
...
bool FieldType::operator<(const FieldType& rhs) const {
  ...
  (void)lhs;
  if (!apache::thrift::StringTraits<std::string>::isEqual(lhs.__fbthrift_field_filedName, rhs.__fbthrift_field_filedName)) {
    return apache::thrift::StringTraits<std::string>::isLess(lhs.__fbthrift_field_filedName, rhs.__fbthrift_field_filedName);
  }
  if (!(lhs.valueType_ref() == rhs.valueType_ref())) {
...
template uint32_t FieldType::serializedSize<>(apache::thrift::BinaryProtocolWriter const*) const;
template uint32_t FieldType::serializedSizeZC<>(apache::thrift::BinaryProtocolWriter const*) const;
...
template uint32_t FieldType::serializedSize<>(apache::thrift::CompactProtocolWriter const*) const;
template uint32_t FieldType::serializedSizeZC<>(apache::thrift::CompactProtocolWriter const*) const;
...
RecordType::RecordType(RecordType&& other) noexcept  :
    ...
    __fbthrift_field_fieldNameIndexMap(std::move(other.__fbthrift_field_fieldNameIndexMap)),
    __isset(other.__isset) {
}
...
RecordType& RecordType::operator=(FOLLY_MAYBE_UNUSED RecordType&& other) noexcept {
    ...
    this->__fbthrift_field_fieldNameIndexMap = std::move(other.__fbthrift_field_fieldNameIndexMap);
    __isset = other.__isset;
    return *this;
}


RecordType::RecordType(apache::thrift::FragileConstructor, std::pmr::vector<nebula::client::FieldType> fieldType__arg, std::pmr::unordered_map<::std::string, ::std::int32_t> fieldNameIndexMap__arg) :
...
const std::pmr::unordered_map<::std::string, ::std::int32_t>& RecordType::get_fieldNameIndexMap() const& {
...
template uint32_t RecordType::serializedSize<>(apache::thrift::BinaryProtocolWriter const*) const;
template uint32_t RecordType::serializedSizeZC<>(apache::thrift::BinaryProtocolWriter const*) const;
...
template uint32_t RecordType::serializedSize<>(apache::thrift::CompactProtocolWriter const*) const;
template uint32_t RecordType::serializedSizeZC<>(apache::thrift::CompactProtocolWriter const*) const;
...
RawRecord::RawRecord(apache::thrift::FragileConstructor, std::pmr::vector<nebula::client::Value> values__arg) :
    __fbthrift_field_values(std::move(values__arg)) {
  __isset.set(folly::index_constant<0>(), true);
}
...
template uint32_t RawRecord::serializedSize<>(apache::thrift::BinaryProtocolWriter const*) const;
template uint32_t RawRecord::serializedSizeZC<>(apache::thrift::BinaryProtocolWriter const*) const;
...
template uint32_t RawRecord::serializedSize<>(apache::thrift::CompactProtocolWriter const*) const;
template uint32_t RawRecord::serializedSizeZC<>(apache::thrift::CompactProtocolWriter const*) const;
...
BindingTable::BindingTable(BindingTable&& other) noexcept  :
    __fbthrift_field_columnNames(std::move(other.__fbthrift_field_columnNames)),
...
BindingTable& BindingTable::operator=(FOLLY_MAYBE_UNUSED BindingTable&& other) noexcept {
    this->__fbthrift_field_columnNames = std::move(other.__fbthrift_field_columnNames);
...
BindingTable::BindingTable(apache::thrift::FragileConstructor, std::pmr::vector<::std::string> columnNames__arg, std::pmr::deque<nebula::client::RawRecord> records__arg) :
    __fbthrift_field_columnNames(std::move(columnNames__arg)),
...
void BindingTable::__clear() {
  // clear all fields
  this->__fbthrift_field_columnNames.clear();
...
bool BindingTable::operator==(const BindingTable& rhs) const {
  ...
  auto& lhs = *this;
  (void)lhs;
  if (!(lhs.columnNames_ref() == rhs.columnNames_ref())) {
    return false;
  }
...
const std::pmr::vector<::std::string>& BindingTable::get_columnNames() const& {
  return __fbthrift_field_columnNames;
}

std::pmr::vector<::std::string> BindingTable::get_columnNames() && {
  return std::move(__fbthrift_field_columnNames);
}
...
template uint32_t BindingTable::serializedSize<>(apache::thrift::BinaryProtocolWriter const*) const;
template uint32_t BindingTable::serializedSizeZC<>(apache::thrift::BinaryProtocolWriter const*) const;
...
template uint32_t BindingTable::serializedSize<>(apache::thrift::CompactProtocolWriter const*) const;
template uint32_t BindingTable::serializedSizeZC<>(apache::thrift::CompactProtocolWriter const*) const;
...
namespace nebula { namespace cpp2 { namespace {
