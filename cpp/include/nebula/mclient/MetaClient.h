...
private:
    ...
    void loadLeader(const std::vector<nebula::client::meta::cpp2::HostItem> &hostItems,
...
private:
    ...
    std::unordered_map<std::pair<GraphSpaceID, PartitionID>, HostAddr, pair_hash>
            spacePartLeaderMap_;
    ...
    std::shared_ptr<thrift::ThriftClientManager<meta::cpp2::MetaServiceAsyncClient>>
            clientsMan_;
};
